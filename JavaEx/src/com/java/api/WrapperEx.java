...
public class WrapperEx {
	...
	public static void main(String[] args) {
		...
		// 위의 방식은 jdk9 에서 Deperecated
		float f = Float.valueOf(3.14159f);
		Boolean b = Boolean.valueOf(true);
		
		// 기본 타입은 비어있을수없고(null 허용 안함)
		// Wrapper 타입은 비어있을 수 있다(null 허용)
		// b2  = bull // X
		b = null;
		
		// 활용
		// 문자열로 된 데티러를 변화 할 때 활용
		Integer i2 = Integer.valueOf("2020");
		// 주의 : valueOf 내부의 문자열 인자의 형태가 해당 데이터 타입으로 변환할 수 잇는 형태여야 한다
		
		// 내부 포장된 값의 비교
		System.out.println("i의 값: "+i.intValue());
		System.out.println("i와 i2의 값은 같은가? " + (i.intValue() == i2.intValue()));
