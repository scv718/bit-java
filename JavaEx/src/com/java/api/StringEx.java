...
public class StringEx {
	...
	private static void stringBufferEx() {
		...
		// -> 내부에 버퍼(임시저장공간)를 가진 StringBuffer를 활용하면 메모리 관리에 용이
		...
		System.out.println("체이닝 조합된 문자열: "+sb2);
	}
	...
	private static void stringMethods() {
		...
		System.out.println("fun 문자열의 위치 인덱스: "+s.indexOf("fun")); // -1 -> 해당 문자열을 찾을 수 없음
		...
		// 문자열 분리: split
		String[] chunks = s.replace("?", "").split(" "); // 공백을 기준으로 분리 -> 문자열을 배열로 
