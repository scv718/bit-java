package com.java.basic.refrypes;
...
public class ArrayEx {
	...
	public static void arrayMemoryTest() {
		...
		System.out.println("scores의 0번 방: "+scores2[0]);
		
		System.out.println("scores 와 scores2는 같은 객체? "+ (scores == scores2));
	...
	public static void arrayBasic() {
		...
		// 문자열 배열: names -> 선언 한 후 초기화
		// float 배열 : heights -> 선언과 동시에 값
		// int 배열 : scores -> 빈 배열 생성 후 채우기
		
		String[] names; // = String names[] 둘다 같음
		int scores[]; // int[] scores 와 같음
